...
SetHoldC[PrivateHold, PrivateSeq];
MakeBoxes[PrivateHold[e_], fmt_] := MakeBoxes[e, fmt];

SetHoldSeq[PrivateSeq];
...
CodePaneBoxes[e_, sz:Except[_Rule], opts___Rule] := Block[
  ...
  {exprBoxes = MakeTruncatedBoxes[Unevaluated @ e, charLimit, Max[charLimit - 5, 3], 8]},
  PaneBox[exprBoxes,
...
heldKeyValPair[key_ :> val_] := {key, PrivateHold @ val};
